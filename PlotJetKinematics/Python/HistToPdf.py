...
def RootHisttoPdf(outFileName,data1,logyScale,dataNumber,yAxisTitle,xAxisTitle,title,data2=None,data3=None):
    ...
    legend.AddEntry(data1,"Jet1 data")
    if dataNumber > 2:
...
RootHisttoPdf(outDirectory+"yboost.pdf",yboostData,False,1,"N","Yboost","Yboost values")
#create chi pdf
chiData = Kinematics.Get("datachi")
RootHisttoPdf(outDirectory+"chi.pdf",chiData,False,1,"N","Chi","Chi values")
#create mjj pdf
mjjData = Kinematics.Get("datamjj")
RootHisttoPdf(outDirectory+"mjj.pdf",mjjData,True,1,"N","Mjj [GeV]","Mjj values")
