int TreeToHist()
{
  ...
  char outNameJet1[] = "/home/jmuecke/code/mueckejonas/BachelorArbeitJM/BachelorStorage/PlotJetKInematics/Root/Hists_Run2023B.root";
  ...
  jec2.Sumw2();
  TH1D muf2("datamuf2","muf for jet2 data",50,0,0.15);
  muf2.Sumw2();
  TH1D nhf2("datanhf2","nhf for jet2 data",50,0,0.4);
  nhf2.Sumw2();
  ...
  nemf2.Sumw2();
  TH1D cemf2("datacemf2","cemf for jet2 data",50,0,0.15);
  cemf2.Sumw2();
  ...
  jec3.Sumw2();
  TH1D muf3("datamuf3","muf for jet3 data",50,0,0.15);
  muf3.Sumw2();
  TH1D nhf3("datanhf3","nhf for jet3 data",50,0,0.4);
  nhf3.Sumw2();
  ...
  nemf3.Sumw2();
  TH1D cemf3("datacemf3","cemf for jet3 data",50,0,0.15);
  cemf3.Sumw2();
